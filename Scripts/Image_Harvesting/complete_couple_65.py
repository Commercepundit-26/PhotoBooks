...
QUERIES = [
    "happy romantic couple smiling outdoor dates",
    "loving couple walking city street winter coats",
    "young couple embracing sunset mountains travel",
    "couple cafe table coffee date laughing",
    "couple enjoying park picnic blanket summer",
    "couple dancing at home laughing kitchen dinner",
    "couple portrait outdoor smiling cheerful authentic",
    "happy couple road trip scenic car journey"
]
