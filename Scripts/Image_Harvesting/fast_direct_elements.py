...
URLS = [
    "https://elements.envato.com/photos/couple-in-love",
    "https://elements.envato.com/photos/romantic-couple-park",
    "https://elements.envato.com/photos/young-couple-smiling",
    "https://elements.envato.com/photos/couple-coffee-date",
    "https://elements.envato.com/photos/couple-holding-hands",
    "https://elements.envato.com/photos/couple-autumn-walk",
    "https://elements.envato.com/photos/couple-laughing-together",
    "https://elements.envato.com/photos/couple-travel-outdoors"
]
...
with sync_playwright() as p:
    ...
    for url in URLS:
        ...
        print(f"\n[Status: {cur_count:02d}/{TARGET_TOTAL}] -> Navigating to: {url}")
