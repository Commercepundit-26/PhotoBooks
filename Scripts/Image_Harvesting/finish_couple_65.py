...
QUERIES = [
    "romantic couple selfie smiling casual clothes",
    "happy couple holding hands autumn park bench",
    "young couple looking into eyes love close up",
    "couple cafe table smiling coffee date",
    "couple hugging winter hats jackets laughing"
]
