...
SEARCH_CONFIG = {
    "Landscape": ["friends party celebration", "friends laughing outdoor", "friends travel road trip"],
    "Portrait": ["friends portrait smiling", "best friends vertical", "young friends lifestyle"],
    "Square": ["friends selfie square", "friends cafe coffee", "friends group square"]
}

print("="*70)
print("ENVATO ELEMENTS: FAST FULL-RES HARVESTER — CATEGORY: FRIENDS")
print("Target: 20 Landscape, 20 Portrait, 20 Square")
print("="*70)
...
with sync_playwright() as p:
    ...
    for orientation, target in TARGETS.items():
        ...
        for q in SEARCH_CONFIG[orientation]:
            if have >= target:
                break
            print(f"  -> Search: '{q}'")
