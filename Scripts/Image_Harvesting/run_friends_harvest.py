...
print("="*70)
print("ENVATO ELEMENTS: HARVESTING 60 MASTER PHOTOS FOR 'FRIENDS'")
print("="*70)
...
with sync_playwright() as p:
    ...
    for orientation, target in TARGETS.items():
        ...
        inp.fill("friends lifestyle party")
        inp.press("Enter")
        time.sleep(3)
        ...
        try:
            ...
            if orient_btn.is_visible():
                ...
                if opt.is_visible():
                    opt.click()
                    print(f"Applied filter: {orientation}")
                    time.sleep(2)
        ...
        while have < target and scroll_count < 35:
            scroll_count += 1
        ...
        print(f"✓ Completed {orientation}: {have}/{target} master photos.")
