...
REQUIRED_KEYWORDS = ['baby', 'infant', 'newborn', 'toddler', 'child', 'kid', 'nursery', 'son', 'daughter', 'mother', 'father', 'parents', 'cute', 'little-boy', 'little-girl', 'feet', 'toes', 'hands', 'crawling']
...
SEARCH_TERMS = [
    ...
    "cute baby taking bath playing with rubber duck",
    "adorable baby laughing tummy time mirror",
    "baby hugging stuffed toy soft plush smiling",
    "mother feeding baby breakfast smiling highchair",
    "baby smiling looking up curious joyful portrait",
    "cute smiling baby in cozy white onesie",
    "father holding baby high in air laughing outdoor",
    "adorable baby laughing at camera close up portrait",
    "happy toddler running in park smiling sunny"
]
