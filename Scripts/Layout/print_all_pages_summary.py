...
with open("/Users/cp/Ronak/CC/Photobooks/Scripts/Layout/_print_summary.jsx", "w") as f:
    f.write(jsx)

subprocess.run(["osascript", "-e", 'tell application "Adobe Illustrator" to do javascript file "/Users/cp/Ronak/CC/Photobooks/Scripts/Layout/_print_summary.jsx"'])
