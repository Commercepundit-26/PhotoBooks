...
with open("/Users/cp/Ronak/CC/Photobooks/Scripts/Layout/_test_clamp.jsx", "w") as f:
    f.write(jsx)

res = subprocess.run(["osascript", "-e", 'tell application "Adobe Illustrator" to do javascript file "/Users/cp/Ronak/CC/Photobooks/Scripts/Layout/_test_clamp.jsx"'], capture_output=True, text=True)
