...
jsx_path = os.path.join(BASE_DIR, "generate_wedding_system.jsx")
with open(jsx_path, "w") as f:
    f.write(jsx_code)

print("\nExecuting complete Photobook Generation in Adobe Illustrator...")
...
print("✓ Adobe Illustrator operations completed!")

if os.path.exists(LOG_FILE):
    with open(LOG_FILE) as f:
        print("\n--- Illustrator Progress Log ---")
        print(f.read().strip())
        print("--------------------------------")

# Resize Blank Previews to max 1000px
...
# Resize Populated Previews to max 1000px
