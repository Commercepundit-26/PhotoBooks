...
// 2. Create New Photobook Document
...
// 3. Place Backgrounds on all 21 Artboards
var bgFilePaths = [
...
// 4. Duplicate matching layout vector shapes & text from srcDoc
...
for (var p = 0; p < 7; p++) {
    copyArtboardLayout(srcSquareAB[p], p);         // Square (0..6)
    copyArtboardLayout(srcLandAB[p], 7 + p);       // Landscape (7..13)
    copyArtboardLayout(srcPortAB[p], 14 + p);      // Portrait (14..20)
}
...
// 5. Export Step A: Blank Layout Previews (Backgrounds + Layout Gray Boxes)
...
// 6. Step B: Mask Photos into Layout Containers
