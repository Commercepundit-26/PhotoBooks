...
jsx_path = os.path.join(BASE_DIR, "capture_all_artboards.jsx")
with open(jsx_path, "w") as f:
    f.write(jsx_script)

print("Capturing 21 individual blank artboards + 21 individual populated artboards...")
...
print("✓ All 42 captures generated successfully!")

# Resize and organize Blank Previews
print("\nProcessing 21 Blank Layout Previews (Max 1000px)...")
for a in range(1, 22):
...
print("\nProcessing 21 Populated Layout Previews (Max 1000px)...")
for a in range(1, 22):
...
print("✓ ALL 21 INDIVIDUAL BLANK & 21 INDIVIDUAL POPULATED ARTBOARDS EXPORTED PERFECTLY!")
