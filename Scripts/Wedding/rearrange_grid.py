...
TARGET_AI = "/Users/cp/Ronak/CC/Photobooks/New/Wedding-Test/Wedding_Photobook_3Sizes.ai"
...
jsx_path = os.path.join(BASE_DIR, "Scripts", "regrid_artboards.jsx")
with open(jsx_path, "w") as f:
    f.write(jsx_regrid)

cmd = f'osascript -e \'tell application "Adobe Illustrator" to do javascript file "{jsx_path}"\''
subprocess.run(cmd, shell=True)
print("✓ Artboards reorganized into clean columns by background theme!")
